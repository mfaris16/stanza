...
def parse_args(args=None):
    ...
    parser.add_argument('--learning_beta2', default=0.95, type=float, help='Beta2 argument for AdamW')
    ...
    # Label Attention
    parser.add_argument('--lattn_d_model', default=1024, type=int, help='Dimension to project the input down to')
    ...
    parser.add_argument('--lattn_d_positional', default=128, type=int, help='Dimension for the positional embedding')
